...
$consumer_key = 'ck_c899ca3af07d4c9e07ebfbd251d55c6b'; // Add your own Consumer Key here
$consumer_secret = 'cs_c60806fc12c94975e04695b6454695cf'; // Add your own Consumer Secret here
$store_url = 'http://www.riverbendgardens.ca/'; // Add the home URL to the store you want to connect to here
...
$completed_orders = $wc_api->get_orders( array( 'status' => 'processing', 'type' => 'variable' ) );
