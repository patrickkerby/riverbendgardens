...
<section class="row csachart justify-content-center">
  ...
  @else 
    ...
    <p>Below is a list of most of the veggies that went out in last year's CSA. Although this year won't neccessarily be the same (due to weather, etc.), it should give you a pretty good idea of variety and quantity.</p>
