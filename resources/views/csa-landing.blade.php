					...
					<div class="row pricing">
						<div class="col-md-12">
							<div>
								...
								<a href="{{ $season_product_biweekly }}" class="button">Coming Soon</a> 
							</div>
						</div>
					</div>
				</div>
				...
				@if ( $include_weeklies )	
					<div class="col-md-6">
						<div>
							...
							<a href="{{ $product_page_weekly }}" class="button">Coming Soon</a> 						
						</div>
					</div>
					<div class="col-md-6">
						<div>
							...
							<a href="{{ $product_page_season }}" class="button">Coming Soon</a> 
						</div>
					</div>
					@else
					<div class="col-md-12">
